...
> Compilación de cursos, libros, librerías y recursos online sobre series temporales con Python, con especial atención a hidrología / hidrogeología y a materiales en español. Pensado como insumo para el diseño del curso *Series Temporales con Python (Komorebi AI)*.
>
> **Fecha de investigación:** 2026-05-12.
> **Método:** búsqueda web estructurada con 4 agentes en paralelo, cubriendo (1) plataformas MOOC, (2) cursos universitarios y libros, (3) recursos específicos de hidrología/hidrogeología, (4) ML/DL especializado y materiales en español.
> **URLs:** todas las referencias incluyen URL — se considera información primaria.
>
> **Cómo leer este documento:**
> - Secciones 1–6: catálogo de fuentes (sin filtrar; preservar fidelidad).
> - Sección 7 (final): síntesis y conclusiones para nuestro currículo.
> - Algunos cursos aparecen en varias secciones (por plataforma y por idioma); es intencionado.
...
*(Ya listado en Coursera — curso 4 del TensorFlow Developer Professional Certificate)*. DeepLearning.AI **no tiene curso stand-alone específico de series temporales** fuera de este.
...
- **Idioma:** **español**
- **Contenido:** *Hidrología Estocástica*, *Modelación Hidrológica y Ambiental Distribuida*
...
- **Autores / año:** Keith W. Hipel & A. Ian McLeod, 1994 (vol. 45 *Developments in Water Science*)
...
- **Capítulo más citado:** Salas (1993). *Analysis and Modeling of Hydrologic Time Series*. Cap. 19 en [Maidment, *Handbook of Hydrology*, McGraw-Hill](https://www.scirp.org/reference/ReferencesPapers?ReferenceID=1186482) — accesible en [Scribd](https://www.scribd.com/document/53252964/Salas-Maidment-1993-Analysis-and-Modeling-of-Hydrologic-Time-Series)
...
#### [Analysis of Hydrologic Time Series — capítulo en *Engineering Hydrology* (Wilson)](https://link.springer.com/chapter/10.1007/978-1-349-03467-3_2)
...
- **Cita:** Collenteur, R., Bakker, M., Caljé, R., Klop, S., Schaars, F. (2019). *Pastas: Open Source Software for the Analysis of Groundwater Time Series*. Groundwater 57(6).
...
- [Bakker & Post — *Analytical Groundwater Modeling: Theory and Applications using Python* (libro)](https://www.routledge.com/Analytical-Groundwater-Modeling-Theory-and-Applications-using-Python/Bakker-Post/p/book/9781138029392)
...
### Patrón 1 — Nadie cubre exactamente nuestro nicho

**Combinación buscada:** Python + español + hidrología + 20 h + estadístico → DL.

- En español hay cursos serios de TS con Python (Gomila, cienciadedatos.net, MLPills) pero **ninguno hidrológico**.
- En hidrología con Python hay cursos sólidos (USGS, Hatari Labs, Australian Water School, IAH/Pastas) pero **mayoritariamente en inglés**, sin foco en series temporales modernas.
- La intersección más cercana es **UPC OCW 250MAG008 (Métodos Estadísticos en Hidrología)** — española, Python, hidrología — pero está dentro de un máster (125 h, 5 ECTS) y enfocada a geoestadística más que a forecasting con DL.

**Conclusión:** existe un hueco claro que nuestro curso llena. La propuesta de valor está bien definida.

### Patrón 2 — La estructura "~20 h, modular, statistical → ML → DL" es estándar

Tres referencias muy cercanas a nuestra duración objetivo:
...
**Conclusión:** la división en 4 sesiones × 5 h con progresión estadísticos → ML → DL es coherente con lo que el mercado considera "completo". No hay que reinventar.

### Patrón 3 — `skforecast` es la mejor puerta de entrada para audiencia hispana
...
### Patrón 4 — DL hidrológico tiene una literatura específica madura
...
### Patrón 5 — `Pastas` es virtualmente la única herramienta open-source madura para piezometría con respuesta a impulsos
...
### Patrón 6 — Foundation models para TS están entrando rápido al currículo
...
### Patrón 7 — R sigue siendo dominante en la academia clásica
...
### Patrón 8 — Datasets españoles oficiales son accesibles vía API
...
### Decisiones que tomar a la vista de la investigación

1. **Reforzar el carácter "español + Python + hidrología"** en la portada y descripción del curso. Es un hueco real y la propuesta lo cubre.
2. **Adoptar `skforecast` (sesión 3) y la suite Nixtla** como librerías principales — mejor soporte hispano y API moderna.
3. **Tratar Pastas en profundidad** (no solo mencionarlo): es la herramienta única en su clase.
4. **Citar Kratzert 2018 + NeuralHydrology** explícitamente en sesión 4. Reproducir un pipeline LSTM minimal sobre CAMELS-ES.
5. **Cerrar con un bloque foundation models** (Chronos/TimeGPT zero-shot sobre el Genil) para conectar con el estado del arte y dar perspectiva.
6. **No replicar el rigor matemático** de cursos universitarios (Stanford, Hamilton). Mantener foco aplicado, según pedía el README.
7. **Bibliografía sugerida al alumno:** fpp3 (Hyndman, online gratis) + Nielsen (Practical Time Series, Python) + Hipel & McLeod (referencia hidrológica) + apuntes UC3M / UCM (en español).
8. **Posible iteración futura** — el curso podría replicarse en inglés o ampliarse a un módulo "Avanzado: DL para hidrología" tras Komorebi v1.
